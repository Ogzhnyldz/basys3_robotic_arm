...
HD_PWD='C:/Users/oguzh/kaydetme/kaydetme.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servolar_kaydetme.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servolar_kaydetme.tcl -notrace

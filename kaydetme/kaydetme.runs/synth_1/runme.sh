...
HD_PWD='C:/Users/oguzh/kaydetme/kaydetme.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servolar_kaydetme.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servolar_kaydetme.tcl
